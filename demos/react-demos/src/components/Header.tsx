...
import { MaterialPage } from '../pages/index.js';
    ...
    <header className="app-bar fixed top-0 left-0 w-screen z-50 bg-surface-container-lowest/80 backdrop-blur-md h-16">
      <div className="flex items-center justify-between w-full h-full px-8">
        ...
        <nav className="flex items-center gap-2">
          <Link to={AboutPage} className="button-text" activeClass="text-primary bg-primary-container/20">
            About
          </Link>
          ...
          <Link to={SignInPage} className="button-text" activeClass="text-primary bg-primary-container/20">
            Sign In
          </Link>
