    ...
    <section className="mb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mb-12">
        <div className="air-field">
          <input id="tf-d1" className="air-text-field" placeholder=" " />
          <label htmlFor="tf-d1" className="air-field-label">
            Outlined Input
          </label>
          <span className="air-field-supporting-text">Supporting text</span>
        </div>
        <div className="air-field">
          <input id="tf-d2" className="air-text-field air-text-field-filled" placeholder=" " />
          <label htmlFor="tf-d2" className="air-field-label">
            Filled Input
          </label>
          <span className="air-field-supporting-text">Supporting text</span>
        </div>
        ...
        <div className="air-field">
          ...
          <input id="tf-d3" className="air-text-field" placeholder=" " />
          <label htmlFor="tf-d3" className="air-field-label">
            With Leading Icon
          </label>
        </div>

        <div className="air-field">
          <input id="tf-d4" className="air-text-field" placeholder=" " />
          <label htmlFor="tf-d4" className="air-field-label">
            With Trailing Icon
          </label>
      ...
      <div className="flex flex-col gap-4 max-w-sm">
        <div className="air-field air-field-sm">
          <input id="tf-s1" className="air-text-field" placeholder=" " />
          <label htmlFor="tf-s1" className="air-field-label">
            Small
          </label>
        </div>
        <div className="air-field air-field-md">
          <input id="tf-s2" className="air-text-field" placeholder=" " />
          <label htmlFor="tf-s2" className="air-field-label">
            Medium
          </label>
        </div>
        <div className="air-field air-field-lg">
          <input id="tf-s3" className="air-text-field" placeholder=" " />
          <label htmlFor="tf-s3" className="air-field-label">
            Large
          </label>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-6 min-w-[280px] pt-4">
          ...
          <div className="relative">
            <label className="air-field">
              <span className="air-field-label">Select an option</span>
              <select className="air-select-field air-select-field-filled" defaultValue="">
